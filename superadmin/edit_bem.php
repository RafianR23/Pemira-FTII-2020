     ...
     <!-- Script Input Presiden-->
        ...
        if(@$_POST['update']){
          ...
          move_uploaded_file($_FILES['foto']['tmp_name'],"images/$foto");
              ...
              $update = mysql_query("update ca_bem set no_urut = '$no_urut', capres = '$capres', sbg = '$sbg', alamat = '$alamat', jurusan = '$jurusan', rekamjejak = '$rekamjejak', visi = '$visi', misi = '$misi', foto = '$foto' where no_urut = '$no_urut' ") or die(mysql_error());
              if ($update) {
                ?> 
