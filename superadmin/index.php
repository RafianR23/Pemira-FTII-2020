...
<html lang="en">
  <head>
    ...
    <title>ADMIN - E-Votting Pemira FIF-FRID</title>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i>Input Data<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?page=pres">Input DPM</a></li>
                   ...
                   <li><a><i class="fa fa-clone""></i>Tampil Data<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?page=tampilbem">Lihat Data DPM</a></li>
                      <li><a href="?page=tampilhima">Lihat Data HIMA</a></li>
                    </ul>
                  </li>
