<div class="page-title">
           <div class="title-left">
			...
			<form action="" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Calon Anggota DPM  </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="sbg" class="form-control">
                            ...
                            <option value="BEM">Anggota DPM</option>
                          </select>
                        </div>
                      </div>
                ...
                if(@$_POST['simpan']){
                  ...
                  if($no_urut == "" || $capres == "" || $sbg == "" || $alamat == "" || $jurusan == "" || $rekamjejak == "" || $visi == "" || $misi == ""|| $foto == "" ){
                    ?> 
                    ...
                    <?php
                            ...
                            $sql_input = mysql_query("insert into ca_bem values('$no_urut','$capres','$sbg','$alamat','$jurusan','$rekamjejak','$visi','$misi','$foto') ") or die(mysql_error());
                            if ($sql_input) {
                              ?> <script type="text/javascript">
                                  alert("Input Data DPM Berhasil");
