<div class="page-title">
           <div class="title-left">
             ...
             <div class="x_panel">
             <div class="x_title">
             	<h2><small><font style="" color="red"><b>NOTE :</b></font> Kolom "ID" diisi sesuai dengan kode jurusan. <b>"1:IF</b></small></h2>
             	 <div class="clearfix"></div>
             </div>
			<form action="" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Calon Ketua dan Wakil HIMA</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
