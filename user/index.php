...
<html lang="en">
  <head>
    ...
    <title>E-Voting Online - Institut Teknologi Telkom Purwokerto</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view" style="">
            <div class="navbar nav_title" style="border: 0;background: linear-gradient(to right bottom, #fdd835, #fff176);">
              <a href="/pemira/user" class="site_title" style="color:#455a64 !important;"><i class="fa fa-user"></i> <span>Informatika</span></a>
            </div>
