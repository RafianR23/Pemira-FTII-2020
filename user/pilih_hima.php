...
?>
            <div class="page-title">
              <div class="title">
                <h3>Tempat Pemilihan HIMA IF</h3>
              </div>
                       ...
                       <?php
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                          <div class="well profile_view">
                            <div class="col-sm-12">
                              <h4 class="brief"><center>Calon HIMA IF</center></h4>
                            </div> <br>
                                ...
                                <div class="col-xs-12 bottom text-center">
                                  <!-- <div style="float: left;" class="col-xs-12 col-sm-6 emphasis"> -->
                                    <button type="button" class="btn btn-success btn-xs"> 
                                      ...
                                      <?php echo "<a href='vot_hima.php?no=$tmpl[no]' style='color: white;padding:0.5em;'> <i class='fa fa-check-square-o'> Pilih </i> </a>";?> 
                                    </button>
                                    <button type="button" class="btn btn-warning btn-xs">
                                      <a href="?page=profile_hima&no=<?php echo $tmpl['no']; ?>" style='color: white;padding:0.5em;'> Profile <i class="fa fa-user"> 
                                      </i></a>
                                    </button>
                              <!-- </div> -->
                            </div>
